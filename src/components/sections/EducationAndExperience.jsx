  ...
  return (
    <section id="education-and-experience" className="mt-20 mx-4 lg:mx-20 flex flex-col md:flex-row gap-4 md:gap-2">
      ...
      <div className="w-full md:w-[80%]">
        {/* =========== EDUCATION TITLE =========== */}
        <h4 className="text-xl dark:text-white mb-2 font-bold flex gap-2 items-center">
          <FaLandmark className="text-xl text-teal-800 dark:text-teal-500" />
          Education
        </h4>
      ...
      <div className="w-full">
        {/* =========== EXPERIENCE TITLE =========== */}
        <h4 className="text-xl dark:text-white mb-2 font-bold flex gap-2 items-center">
          <FaBuildingUser className="text-2xl text-teal-800 dark:text-teal-500" />
          Experience
        </h4>

        <div className="md:h-[350px] md:overflow-y-scroll scroll-smooth">
          {/* =========== EXPERIENCE LIST =========== */}
                      ...
                      {exp.descriptions.map((desc, index) => {
                        return (
                          <li className="flex space-x-3" key={index}>
                            <svg
                              className="flex-shrink-0 size-4 mt-0.5 text-teal-800 dark:text-teal-500"
